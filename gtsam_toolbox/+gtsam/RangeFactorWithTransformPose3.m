...
%string_deserialize(string serialized) : returns RangeFactorWithTransformPose3
%
classdef RangeFactorWithTransformPose3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = RangeFactorWithTransformPose3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(3223, varargin{2});
        end
        base_ptr = gtsam_wrapper(3222, my_ptr);
      elseif nargin == 5 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base') && isa(varargin{5},'gtsam.Pose3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3224, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3225, obj.ptr_gtsamRangeFactorWithTransformPose3);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.active');
      end
    end
    ...
    function varargout = clone(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3227, this, varargin{:});
    end

    function varargout = dim(this, varargin)
      % DIM usage: dim() : returns size_t
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3228, this, varargin{:});
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(3230, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3234, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.printKeys');
      end
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransformPose3.whitenedError');
      end
    end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3239, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(3240, varargin{:});
      else
