...
classdef GenericValueVector < gtsam.Value
  ...
  methods
    function obj = GenericValueVector(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(94, varargin{2});
        end
        base_ptr = gtsam_wrapper(93, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(95, obj.ptr_gtsamGenericValueVector);
    end
    ...
    function varargout = dim(this, varargin)
      ...
      varargout{1} = gtsam_wrapper(96, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(97, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.GenericValueVector.print');
      end
    end
