...
%string_deserialize(string serialized) : returns RangeFactorWithTransform3D
%
classdef RangeFactorWithTransform3D < gtsam.NoiseModelFactor
  ...
  methods
    function obj = RangeFactorWithTransform3D(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(3185, varargin{2});
        end
        base_ptr = gtsam_wrapper(3184, my_ptr);
      elseif nargin == 5 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'double') && isa(varargin{4},'gtsam.noiseModel.Base') && isa(varargin{5},'gtsam.Pose3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3186, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3187, obj.ptr_gtsamRangeFactorWithTransform3D);
    end
    ...
    function varargout = active(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.active');
      end
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NoiseModelFactor') && isa(varargin{2},'double')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.equals');
      end
    end
    ...
    function varargout = error(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        ...
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.error');
      end
    end
    ...
    function varargout = linearize(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(3194, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.linearize');
      end
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3196, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.print');
      end
    end
    ...
    function varargout = printKeys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(3197, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.printKeys');
      end
    end
    ...
    function varargout = size(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(3198, this, varargin{:});
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(3199, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.unwhitenedError');
      end
    end
    ...
    function varargout = whitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(3200, this, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.RangeFactorWithTransform3D.whitenedError');
      end
    end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3201, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(3202, varargin{:});
      else
