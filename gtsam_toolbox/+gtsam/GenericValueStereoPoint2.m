...
classdef GenericValueStereoPoint2 < gtsam.Value
  ...
  methods
    function obj = GenericValueStereoPoint2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(129, varargin{2});
        end
        base_ptr = gtsam_wrapper(128, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(130, obj.ptr_gtsamGenericValueStereoPoint2);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(132, this, varargin{:});
      else
